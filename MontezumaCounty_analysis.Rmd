...
my.counties <- c("Colorado.Mesa", "California.Santa Clara", "Colorado.La Plata", "Oregon.Lane","Arizona.Maricopa", "California.Alameda", "New Mexico.San Juan", "Arizona.Navajo")
...
```{r states, include=F}
my.states <- c("California","Utah","Colorado", "Oregon","Florida", "New Jersey","Michigan","Pennsylvania")
